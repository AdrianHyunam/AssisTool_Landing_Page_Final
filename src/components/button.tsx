...
export const Button = ({text, style=''}:Props) => {
  ...
  return (
   <button onClick={handleClick} className={`btn-ripple xl:text-3xl bg-gray-500 text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-gray-900 transition-all "${style} cursor-pointer`}>
        {text}
   </button>
