export const Description = () => {
  return (
    <div className="mt-10 mx-auto md:flex md:items-center md:gap-4 reveal-on-scroll lg:w-[1300px]">
          <img className="mb-10 md:w-[450px] md:h-[320px] lg:w-[1400px] lg:h-[550px] relative aspect-square rounded-lg overflow-hidden w-full" src="/images/info_sistema.png" alt="info sistema" />
      <div>
