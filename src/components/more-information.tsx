...
export const Moreinformation = () => {
  return (
    <div className="grid grid-cols-1 mt-10 mx-auto md:flex md:items-center md:gap-4 reveal-on-scroll">
      <div>
      ...
      <ul className="mb-4">
        ...
        <img className="mb-10 md:w-[450px] md:h-[550px] lg:w-[1300px] lg:h-[400px] relative aspect-square rounded-lg overflow-hidden w-full bg-gray-100 cursor-pointer group" src="/images/funciones_internas.png" alt="info sistema" />
